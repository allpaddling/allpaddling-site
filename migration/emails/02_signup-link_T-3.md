---
template: 02_signup-link_T-3
when: 3 days before next renewal
purpose: Send signup link with plan + price pre-filled. Action required.
---

# Subject

Action needed: your one-click link to move to the new All Paddling
